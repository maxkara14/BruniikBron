const siteData = {
    extensions: [
        ...
        },
        {
            ...
            description: "Терминал интерактивной карты и пространственной памяти. В один клик сканирует локацию и визуализирует окружение (персонажей, объекты, угрозы) на сетке 3x3, внедряя сводку в контекст ИИ. Поддерживает кастомные API и интеграцию через макросы.",
