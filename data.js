const siteData = {
    extensions: [
        ...
        },
        {
            ...
            description: "Интерактивная панель инструментов для SillyTavern, стирающая грань между текстовым чатом и полноценной RPG. Включает литературное расширение и редактуру текста (Enhance/Improve), режиссуру случайных событий, проверку навыков с анимированным 3D-кубиком (Action Roll) и умную систему быстрого перемещения между локациями (Fast Travel). Панель полностью адаптирована для ПК и мобильных устройств.",
